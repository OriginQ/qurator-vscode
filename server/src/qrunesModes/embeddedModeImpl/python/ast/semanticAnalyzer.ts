...
import { VariableSymbol, MethodSymbol, ArgumentSymbol } from '../compiler/symbols';
import { ErrorBuilder } from './tools/errorBuilder';
import { SymbolTable } from '../../commonCompiler/types';
import { Type, BuiltInTypeSymbol } from '../../commonCompiler/symbols';
import { VariableDefinition } from '../../commonCompiler/variableDefinition';
